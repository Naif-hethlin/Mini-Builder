    ...
    <div className="aspect-[16/9] w-full overflow-hidden rounded border border-stone-200 bg-white p-2">
      ...
      <div className="grid grid-cols-3 gap-1">
        {[0, 1, 2].map((i) => (
          <div
            key={i}
            className="flex flex-col items-start gap-0.5 rounded-sm bg-stone-50 p-1"
          >
            <div className="h-1.5 w-1.5 rounded-sm bg-stone-400" />
            <div className="h-1 w-full rounded-sm bg-stone-300" />
            <div className="h-0.5 w-full rounded-sm bg-stone-200" />
          </div>
        ))}
      </div>
    </div>
