  ...
  return (
    <section className="bg-animated-gradient relative flex min-h-screen w-full items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center justify-center px-6 text-center">
        ...
        <div className="mb-6 flex min-h-[70px] w-full animate-fade-in-up items-center justify-center fade-in-start [animation-delay:100ms] sm:min-h-[90px] md:min-h-[100px]">
          <h1 className="flex items-center justify-center gap-x-2 whitespace-nowrap text-xl leading-tight font-extrabold sm:gap-x-3 sm:text-3xl md:text-5xl lg:text-6xl">
            <span>أنشئ</span>
            <span className="relative flex items-center">
              <span className="inline-block text-brand">{text}</span>
              <span className="ms-1 inline-block h-6 w-[3px] animate-blink bg-brand sm:h-9 md:h-12 lg:h-14" />
            </span>
          </h1>
        </div>
